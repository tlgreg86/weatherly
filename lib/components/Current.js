     ...
     <section className='current-container'>
       <section className='current-card'>
         <h2 className='current-location'>
           {currentWeather[0].current_observation.display_location.city}, {currentWeather[0].current_observation.display_location.state}
         </h2>
         ...
         <h3 className='temp-container'>
           ...
           <img src={currentWeather[0].current_observation.icon_url} alt='Weather'/>
           <p className = 'high-low'>{currentWeather[0].forecast.simpleforecast.forecastday[0].high.fahrenheit}/{currentWeather[0].forecast.simpleforecast.forecastday[0].low.fahrenheit}</p>
         </h3>
